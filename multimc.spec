...
install -D -m 0644 application/resources/multimc/scalable/multimc.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/apps/%{name}.svg
install -D -m 0644 application/package/linux/%{name}.desktop %{buildroot}%{_datadir}/applications/%{name}.desktop
